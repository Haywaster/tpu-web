...
const AuthorizationPage = () => {
	const {register, postLoginData, handleSubmit, errors, isLoadingLogin} = useRegistration()
	...
	return (
		<Layout>
			<form className={ adminStyles.authorizationForm } onSubmit={ handleSubmit(onSubmit) }>
				...
				<ErrorMessage errors={errors as IErrors} name={'root.loginError'}/>
				{isLoadingLogin ? <Loader/> : <input className={ adminStyles.btn } type='submit' value='Login'/>}
			</form>
		</Layout>
	);
};
